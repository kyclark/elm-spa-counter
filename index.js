...
var $author$project$Page$Counter$init = 0;
var $author$project$Main$changeRouteTo = F2(
	function (maybeRoute, model) {
		if ((maybeRoute.$ === 'Just') && (maybeRoute.a.$ === 'Counter')) {
			var _v1 = maybeRoute.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						cur_page: $author$project$Main$Counter($author$project$Page$Counter$init)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
...
var $author$project$Route$Counter = {$: 'Counter'};
...
var $author$project$Page$Counter$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick($author$project$Page$Counter$Increment)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('+')
	...
	var header = A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Route$href($author$project$Route$Counter)
					]),
				_List_fromArray(
					[
	...
	if (_v0.$ === 'Home') {
		...
		return $author$project$PageView$view(
			A2(
				...
				$author$project$Page$Counter$view(subModel)));
	}
};
